<template>
  <div class="dashboard-container">
    <div class="chart_box">
      <div id="myChart" :style="{width: '50%', height: '400px'}" />
      <div id="myChart2" :style="{width: '50%', height: '400px'}" />
    </div>
    <div class="drqk_box">
      <div class="title_box">
        <p>今日情况</p>
      ...
      <!-- <el-button type="primary">拨打数：{{ today.callTotalNum }}个</el-button>
      <el-button type="primary">接通数：{{ today.succNum }}个</el-button>
      <el-button type="primary">通话时长：{{ SecondToDate(today.totalTime) }}</el-button>
      <el-button type="primary">接通率：{{ today.onRate*100 }}%</el-button> -->
    </div>
    <div class="table_box shaowAll">
      ...
      <el-table
        ...
        :data="yxhdlist"
        tooltip-effect="dark"
        style="width:95%;margin:10px auto 20px auto;padding-bottom:100px"
        border
