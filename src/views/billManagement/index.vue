...
<script>
import { selectAllCallLogPage } from '@/api/chengxu'
  ...
  methods: {
    ...
    async getlist() {
      ...
      if (_this.query.time) {
        ...
        await selectAllCallLogPage(data).then(res => {
          console.log(res)
        ...
        const data = {
          param: {
            ...
            current: _this.hwCurrent,
            size: _this.hwSize,
            startTime: _this.hstTime ? '' : _this.hstTime,
            endTime: _this.thisTime ? '' : _this.thisTime
          }
        }
        await selectAllCallLogPage(data).then(res => {
          console.log(res)
